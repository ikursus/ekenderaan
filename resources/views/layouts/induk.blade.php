...
@include('layouts.sidebar')
        ...
        <script src="/themes/sbadmin/assets/demo/chart-area-demo.js"></script>
        <script src="/themes/sbadmin/assets/demo/chart-bar-demo.js"></script>
